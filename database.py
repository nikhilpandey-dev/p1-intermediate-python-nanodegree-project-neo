...
class NEODatabase:
    ...
    def query(self, filters=()):
        ...
        for approach in self._approaches:
            flag: bool = True
            """ All the filters jointly form a giant and statemnt so if any condition is false, then that approach will not be considered and hence just considering to test even if one condition is false. """
